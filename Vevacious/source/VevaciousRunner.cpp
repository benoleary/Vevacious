...
"# minimum is not deeper than the field origin at zero temperature.\n"
"    def FindEvaporationTemperature( self,\n"
"                                    evaporatingMinimum,\n"
"                                    logTwoAccuracy = 7 ):\n"
"# As a 1st guess, we take the temperature such that the SM thermal\n"
"# corrections at zero VEVs would equal the difference:\n"
"        zeroTemperatureDepth = evaporatingMinimum[  \"PotentialValue\" ]\n"
"        originDepth = self.potentialScaler.functionAtOrigin\n"
"        if ( zeroTemperatureDepth >= originDepth ):\n"
"            return [ 0.0, 0.0 ]\n"
"# The corrections are ( T^4 / ( 2 pi^2 ) ) * sum of J functions, and the\n"
"# values of the J functions are about 2 for massless bosonic & fermionic\n"
"# degrees of freedom, & there are ~100 degrees of freedom in the SM. Hence\n"
...
"        print( \"The field origin becomes deeper between \"\n"
"               + str( evaporationTemperatureGuess )\n"
"               + \" GeV and \"\n"
"               + str( 2.0 * evaporationTemperatureGuess )\n"
"               + \" GeV.\\n\" )\n"
"        self.SetTemperature( evaporationTemperatureGuess )\n"
"        thermalMinimum = self.TryToMinimize( evaporatingMinimum[\n"
"                                                        \"FieldValues\" ] )\n"
"        while ( thermalMinimum[ \"PotentialValue\" ] < originDepth ):\n"
"            evaporationTemperatureGuess = ( 2.0\n"
"                                            * evaporationTemperatureGuess )\n"
"            print( \"Trying \"\n"
"                   + str( evaporationTemperatureGuess )\n"
...
"            thermalMinimum = self.TryToMinimize( evaporatingMinimum[\n"
"                                                        \"FieldValues\" ] )\n"
"            if ( thermalMinimum[ \"PotentialValue\" ] < originDepth ):\n"
"                justBelowEvaporationTemperature = (\n"
"                                              evaporationTemperatureGuess )\n"
"            else:\n"
"                justAboveEvaporationTemperature = (\n"
...
"                               ( 0.25 * criticalTemperatureRange[ 0 ] ),\n"
"                               ( 0.5 * criticalTemperatureRange[ 0 ] ),\n"
"                               ( 0.75 * criticalTemperatureRange[ 0 ] ),\n"
