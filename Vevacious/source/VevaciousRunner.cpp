...
"# fitted function in the temperature, so that we can estimate the most\n"
...
"# We take the zero-temperature path as part of the fit:\n"
...
"\n"
"        minimumSeparationSquared = ( vcs.rollingToleranceSquared\n"
...
"\n"
"        panicThresholdLengthSquared = ( 0.2 * 0.2\n"
"                                         * numpy.sum( vcs.panicArray**2 ) )\n"
"\n"
"        def PanicMinimumHasNotEvaporated( thermalPanicMinimum ):\n"
"            thermalArray = VPD.FieldDictionaryToArray( thermalPanicMinimum[\n"
"                                                        \"FieldValues\" ] )\n"
"            return ( panicThresholdLengthSquared < numpy.sum(\n"
"                                                        thermalArray**2 ) )\n"
"\n"
"        def TunnelingPossible( falseVacuum, trueVacuum ):\n"
"            return ( MinimaAreDistinct( falseVacuum, trueVacuum )\n"
"                     and\n"
"                     PanicMinimumHasNotEvaporated( trueVacuum )\n"
"                     and\n"
...
"        criticalTemperatureAccuracy = 7\n"
"        for narrowingStep in range( criticalTemperatureAccuracy ):\n"
...
"# should be within a factor of ( 1 + 2^(-criticalTemperatureAccuracy) )\n"
...
"# lowest.\n"
"# Fitting ( a (T/Q)^2 + b (T/Q) + c ) * ( Tc - T )^(-2) to the actions at\n"
"# T/Q = 0.0, 0.5, and 1.0 leads to:\n"
"            actionArray = numpy.array( [ temperatureWithThermalAction[ 1 ]\n"
"                                        for temperatureWithThermalAction in\n"
"                                         temperaturesWithThermalActions ] )\n"
"# We estimate that the critical temperature by the geometric average of the\n"
"# 2 temperatures that we know are just above and below it.\n"
"            criticalTemperature = math.sqrt( justBelowCriticalTemperature\n"
"                                           * justAboveCriticalTemperature )\n"
"            def transformationElement( temperatureValue,\n"
"                                       degreeOfPolynomial ):\n"
"                return ( ( temperatureValue**degreeOfPolynomial )\n"
"                         / ( criticalTemperature - temperatureValue )**2 )\n"
"            def transformationVector( temperatureValue ):\n"
"                return numpy.array( [ transformationElement(\n"
"                                                          temperatureValue,\n"
"                                                       degreeOfPolynomial )\n"
"                                    for degreeOfPolynomial in range( 3 ) ] )\n"
"            transformationMatrix = numpy.array( [ transformationVector(\n"
"                                numberOfHalves * 0.5 * highestTemperature )\n"
"                                       for numberOfHalves in range( 3 ) ] )\n"
"            coefficientArray = numpy.linalg.solve( transformationMatrix,\n"
"                                                   actionArray )\n"
"            print( \"S_3 parameterized as (\"\n"
"                   + str( coefficientArray[ 2 ] )\n"
"                   + \") T^2 + (\"\n"
"                   + str( coefficientArray[ 1 ] )\n"
"                   + \") T + (\"\n"
"                   + str( coefficientArray[ 0 ] )\n"
"                   + \") * ( (\"\n"
"                   + str( criticalTemperature )\n"
"                   + \") - T )^(-2)\\n\\n\" )\n"
"                   \n"
...
"            quadraticCoefficient = coefficientArray[ 2 ]\n"
"            linearCoefficient = coefficientArray[ 1 ]\n"
"            constantCoefficient = coefficientArray[ 0 ]\n"
"            def ThermalActionOverT( T ):\n"
"                return ( ( ( quadraticCoefficient * T * T )\n"
"                           + ( linearCoefficient * T )\n"
"                           + constantCoefficient )\n"
"                         / ( ( criticalTemperature - T )**2 * T ) )\n"
"\n"
...
"            temperatureFitMinuit.limits[ \'T\' ] = ( 1.0,\n"
"                                             justBelowCriticalTemperature )\n"
"            temperatureFitMinuit.values[ \'T\' ] = ( 0.5\n"
"                                           * justBelowCriticalTemperature )\n"
"            try:\n"
"                temperatureFitMinuit.migrad()\n"
"                exclusionTemperature = temperatureFitMinuit.values[ \'T\' ]\n"
...
"                        + \" used.\" )\n"
"                [ exclusionTemperature,\n"
"               currentThermalAction ] = temperaturesWithThermalActions[ 2 ]\n"
"                if ( temperaturesWithThermalActions[ 1 ][ 1\n"
"                                                ] < currentThermalAction ):\n"
"                    [ exclusionTemperature,\n"
"               currentThermalAction ] = temperaturesWithThermalActions[ 1 ]\n"
"                if ( temperaturesWithThermalActions[ 0 ][ 1\n"
"                                                ] < currentThermalAction ):\n"
"                    [ exclusionTemperature,\n"
"               currentThermalAction ] = temperaturesWithThermalActions[ 0 ]\n"
"\n"
"\n"
"            except Exception as unexpectedException:\n"
"                print( \"Some lower-level exception happened:\\n\"\n"
