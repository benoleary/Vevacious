...
namespace Vevacious
{
  std::string const VevaciousRunner::vevaciousVersion( "1.1.00beta10" );
  std::string const
...
"        self.logOfLogOfThermalProbabilityTimesFactor = -exponentCutOff\n"
...
"# 4.00163E+103 is exp( 238.553 ) which is in agreement with the value of\n"
"# 240 quoted in the CosmoTransitions manual for an estimate of the\n"
"# threshold S_3(T)/T for T= 100 GeV.\n"
...
"# 238.553 * T_opt * ln( ln(1/P) ) where x is either S_3(T_opt) or T_opt.\n"
"            self.logOfLogOfThermalProbabilityTimesFactor = ( 238.553\n"
"                                                       * currentTemperature\n"
"                                                             * math.log(\n"
"                                                                 -math.log(\n"
...
"\n"
"\n"
"    def RollVacuaAtTemperature( self, temperatureGuess ):\n"
...
"            alreadyExcluded = ( thermalAction\n"
"                           < ( self.logOfLogOfThermalProbabilityTimesFactor\n"
"                               - ( trialTemperature\n"
...
"            return 0.0\n"
"        else:\n"
"            integratedDecayWidth = ( math.exp( 238.553\n"
"                                               - actionOverTemperature )\n"
"                                     / currentAction )\n"
"            if ( integratedDecayWidth < -exponentCutOff ):\n"
"                integratedDecayWidth = -exponentCutOff\n"
"                print( \"Warning! Integrated thermal decay width is so\"\n"
"                       + \" large and negative that an overflow error\"\n"
"                       + \" would occur when exponentiating to get the\"\n"
"                       + \" survival probability, so capping it at \"\n"
...
"        criticalTemperatureRange = vcs.FindCriticalTemperature(\n"
"                                                       logTwoAccuracy = 7 )\n"
...
"        temperaturesForFit = [ 0.0,\n"
"                               ( 0.5 * criticalTemperatureRange[ 0 ] ),\n"
"                               ( 1.0 * criticalTemperatureRange[ 0 ] ) ]\n"
"        [ optimalTunnelingTemperature,\n"
"          alreadyExcluded,\n"
"          thermalTunnelingSurvivalProbabilityString\n"
"               ] = vcs.FindOptimalTunnelingTemperature( temperaturesForFit,\n"
"                                             criticalTemperatureRange[ 0 ],\n"
"                                            criticalTemperatureRange[ 1 ] )\n"
"        exclusionTemperatureString = str( optimalTunnelingTemperature )\n"
...
"                   + \" action is \"\n"
"                   + str( vcs.logOfLogOfThermalProbabilityTimesFactor\n"
"                          + ( optimalTunnelingTemperature\n"
"                              * math.log( optimalTunnelingTemperature ) ) )\n"
...
"                   + \" GeV.\\n\\n\" )\n"
"            if ( thermalAction\n"
"                 < ( vcs.logOfLogOfThermalProbabilityTimesFactor\n"
"                     - ( optimalTunnelingTemperature\n"
"                         * math.log( thermalAction ) ) ) ):\n"
"                thermalStabilityVerdict = \"low_survival_probability\"\n"
"                slhaSummaryCode = -2\n"
