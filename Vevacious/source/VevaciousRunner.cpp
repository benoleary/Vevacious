...
"            LogWarning( \"Some lower-level exception happened:\\n\"\n"
...
"print( \"DSB vacuum is \" + vcs.ExtremumAsMathematica( vcs.dsbVacuum ) )\n"
"\n"
...
"                                                        \"FieldValues\" ] )\n"
"            print( \"DSB vacuum rolls to \"\n"
"                   + vcs.ExtremumAsMathematica( newThermalDsbVacuum ) )\n"
"            newThermalPanicVacuum = vcs.TryToMinimize( vcs.panicVacuum[\n"
"                                                        \"FieldValues\" ] )\n"
"            print( \"Panic vacuum rolls to \"\n"
"                     + vcs.ExtremumAsMathematica( newThermalPanicVacuum ) )\n"
...
"\n"
"            print( \"Direct path 3-dimensional action at temperature \"\n"
"                   + str( trialTemperature )\n"
"                   + \" GeV is \"\n"
"                   + str( currentThermalAction ) )\n"
...
"                                                        deformPath = False,\n"
"                                                 thermalNotQuantum = True )\n"
"                    print( \"Calculated thermal action = \"\n"
"                          + str( currentThermalAction ) )\n"
...
"                  + \"  <reference version=\\\" " << vevaciousVersion
<<                                                                   "\\\"\"\n"
