...
"        self.SetMinuitLimits( self.FieldValueLimit )\n"
...
"\n"
"\n"
"    def SetMinuitLimits( self, fieldValueLimit ):\n"
...
"            endPointDictionary = self.FieldValuesFromMinuit(\n"
"                                                     self.PyMinuit.values )\n"
"# We take the point where Minuit gave up as a valid candidate anyway.\n"
"# However, despite having told Minuit to stay within a hypercube, sometimes\n"
"# it just seems to end up wherever it likes. Hence we go through each field\n"
"# for the candidate point, scaling the whole vector down to ensure that\n"
"# each field is within its bounds. Since the vector is shrunk each time,\n"
"# there is no need to revisit the earlier fields if the vector is shrunk by\n"
"# a later field.\n"
"            hadToRescale = False\n"
...
"            endPointAsExtremum = self.FieldDictionaryToExtremum(\n"
"                                                       endPointDictionary )\n"
"            takenPointString = UserFieldsAsMathematica(\n"
"                                                       endPointDictionary )\n"
"            if hadToRescale:\n"
"                takenPointString += (\n"
"                      \" (having had to rescale to within given limits)\" )\n"
"# Now we take either where PyMinuit started, or where it quit, whichever\n"
"# is deeper.\n"
"            if ( endPointAsExtremum[ \"PotentialValue\" ]\n"
"                 < foundExtremum[ \"PotentialValue\" ] ):\n"
"                foundExtremum = endPointAsExtremum\n"
...
"                        + \" GeV^4.\\nTaking the point \"\n"
"                        + takenPointString + \" as a vacuum candidate.\")\n"
